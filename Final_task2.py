...
def stitch_images(img1, img2, a, b):
    ...
    # 2. Create a Canvas That Contains Both Images
    ...
    # 3. Blend the Overlapping Regions
    ...
    overlap = (mask1_bin == 1) & (mask2_bin == 1)
    only1   = (mask1_bin == 1) & (mask2_bin == 0)
    only2   = (mask2_bin == 1) & (mask1_bin == 0)
    ...
    # # 4. Rectify the Stitched Output to an Upright Rectangle
